        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpectedDeparture = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FlightInfo_Airport_FromId",
                        column: x => x.FromId,
                        principalTable: "Airport",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FlightInfo_Airport_ToId",
                        column: x => x.ToId,
                        principalTable: "Airport",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BeverageType = table.Column<int>(nullable: true),
                    ...
                    ObjectStorageId = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Plane_Catalog_CatalogId",
                        column: x => x.CatalogId,
                        principalTable: "Catalog",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CabinCrew_Plane_PlaneId",
                        column: x => x.PlaneId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    Col = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlightInfo_FromId",
                table: "FlightInfo",
                column: "FromId");

            migrationBuilder.CreateIndex(
                name: "IX_FlightInfo_ToId",
                table: "FlightInfo",
                column: "ToId");

...
namespace Ifes.Services
{
    public sealed class CatalogService
    {
        ...
        public IEnumerable<Food> Meals { get { return Catalog.OfType<Food>(); } }
        public IEnumerable<Beverage> Beverages { get { return Catalog.OfType<Beverage>(); } }
        ...
        private IEnumerable<CatalogItem> GetCatalog()
        {
